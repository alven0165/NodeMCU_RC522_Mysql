			...
			<div class="center" style="margin: 0 auto; width:495px; border-style: solid; border-color: #f2f2f2;">
				...
				<form class="form-horizontal" action="user data edit tb.php?id=<?php echo $id?>" method="post">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="lrn" type="text"  placeholder="" value="<?php echo $data['id'];?>" required>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="mname" type="text"  placeholder="" value="<?php echo $data['mname'];?>" required>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<select name="section" id="mySelect">
								<option value="Male">ICT 1</option>
								<option value="Female">ICT 2</option>
							</select>
						</div>
					</div>
