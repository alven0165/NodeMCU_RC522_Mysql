...
<html>
	<head>
		...
		<title>Registration : ATTENDANCE MONITORING SYSTEM</title>
	</head>
	
	<body>

		<h2 align="center">ATTENDANCE MONITORING SYSTEM</h2>
		<ul class="topnav">
		...
		<div class="container">
			<br>
			<div class="center" style="margin: 0 auto; width:495px; border-style: solid; border-color: #f2f2f2; background-color: white; ">
				<div class="row">
				...
				<form class="form-horizontal" action="insertDB.php" method="post" >
					...
					<div class="control-group">
						<label class="control-label">Student LRN</label>
						<div class="controls">
							<input id="div_refresh" name="lrn" type="text"  placeholder="" required>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input id="div_refresh" name="mname" type="text"  placeholder="" required>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input id="div_refresh"name="lname" type="text"  placeholder="" required>
						</div>
					</div>
